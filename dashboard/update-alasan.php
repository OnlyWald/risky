<?php require_once ('../extend/header.php');?>
	...
	<?php
		...
		$data = query("SELECT * FROM data_tier_2 WHERE id_tier_2 = '$id_jawaban'")[0];	
				...
				<div id="form-jawaban">
				    ...
				    <div class="remove" style="margin-bottom: 10px;">
						<div class="wrap" style="display: flex;">
							<input type="hidden" name="fk" value="<?=$data['fk_id_tier_1'];?>">
							<input type="hidden" name="id" value="<?=$data['id_tier_2'];?>">
						    <input type="text" name="jawaban" class="form-control" style="width: 800;"placeholder="Jawaban" value="<?= $data['text_tier_2']?>">
